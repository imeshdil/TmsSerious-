...
API_ID = int(environ.get('API_ID', '21179701'))
API_HASH = environ.get('API_HASH', '1391c79f69373692b7cdb922033b8b62')
BOT_TOKEN = environ.get('BOT_TOKEN', '6344511009:AAFGcGijSqGCTSKV4hdyjTtMTR0bPbntc2s')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6365212390').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001978169890').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = -1001772183420
